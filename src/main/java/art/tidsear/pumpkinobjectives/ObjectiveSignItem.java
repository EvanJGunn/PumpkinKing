...
public class ObjectiveSignItem extends Item {

    public ObjectiveSignItem() {
    ...
    public boolean onItemUse(ItemStack itemStack, EntityPlayer entityPlayer, World world, int x, int y, int z, int facing, float hitX, float hitY, float hitZ) {
        if (facing == 0) {
            ...
            if (!entityPlayer.canPlayerEdit(x, y, z, facing, itemStack)) {
                return false;
            } else if (!PumpkinKingModBlocks.getBlock("objective_standing_sign").canPlaceBlockAt(world, x, y, z)) {
                return false;
                ...
                if (facing == 1) {
                    ...
                    world.setBlock(x, y, z, PumpkinKingModBlocks.getBlock("pumpkinking:objective_standing_sign"), i1, 3);
                    Block block = PumpkinKingModBlocks.getBlock("pumpkinking:objective_standing_sign");
                } else {
                    world.setBlock(x, y, z, PumpkinKingModBlocks.getBlock("pumpkinking:objective_wall_sign"), facing, 3);
                }
